...
/// @notice Mines the address and deploys the MaestroHook.sol Hook contract
contract DeployHookScript is BaseScript {
    function run() public {
        ...
        (address hookAddress, bytes32 salt) =
            HookMiner.find(CREATE2_FACTORY, flags, type(MaestroHook).creationCode, constructorArgs);
